        ...
        <ion-grid>
          ...
          <ion-row>
            <ion-col style="display: flex; justify-content: flex-start;">
              <ion-list>
                <ion-item>
                  <ion-select interface="popover" placeholder="Civilité">
                    <IonSelectOption value="Mme">Mme</IonSelectOption>
                    <IonSelectOption value="Mlle">Mlle</IonSelectOption>
...
import Step1 from '../../assets/images/svg/step/Step1.svg';
